...
const index = () => {
  ...
  const registerAsfarmer = () => {
    router.push({
      pathname: '/register/userRegister',
      params: { user: 'farmer' }
    })
  }
  
  const registerAsVender = () => {
    router.push({
      pathname: '/register/userRegister',
      params: { user: 'buyer' }
    })
  ...
  return (
    <SafeAreaProvider style={styles.container}>
      ...
      <View style={styles.bttnContainer}>
        <TouchableOpacity
          style={styles.farmerBttn}
          onPress={() => registerAsfarmer()}
        >
          <Text style={styles.bttnText}>Register as Farmer</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.venderBttn}
          onPress={() => registerAsVender()}
        >
          <Text style={styles.bttnText}>Register as Vendor</Text>
        </TouchableOpacity>
        <View style={styles.loginLinkContainer}>
          <Text style={styles.registeText}>Already have an account?</Text>
